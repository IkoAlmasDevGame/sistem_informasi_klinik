...
<html lang="en">
    ...
    <head>
        ...
        <title>Login | Poli Klinik Indonesia Islamic</title>
        <link rel="stylesheet" href="../auth/styles.css" crossorigin="anonymous">
        ...
        <?php 
            ...
            $data = $konfigs->query("SELECT * FROM tb_sistem WHERE status = '1' order by id_sistem asc");
