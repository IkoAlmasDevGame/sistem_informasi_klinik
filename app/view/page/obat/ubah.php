            ...
            <div class="panel-body">
                <div class="panel-heading">
                    ...
                    <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                            <a href="?aksi=ubah-obat&id_obat=<?php echo $_GET['id_obat']?>" aria-current="page"
            ...
            <div class="card-body mt-1">
                <div class="table-responsive">
                    <div class="container">
                        ...
                        ?>
                        <form action="?aksi=obat-ubah" method="post">
                                    ...
                                    <div class="card-body mt-lg-2 mt-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-inline row justify-content-center
                                                ...
                                                <div class="col-sm-7 col-md-7">
                                                    <input type="text" name="kd_obat"
                                                        value="<?php echo $pro['kd_obat']?>" maxlength="10"
                                            ...
                                            <div class="form-inline row justify-content-center
                                                ...
                                                <div class="col-sm-7 col-md-7">
                                                    <input type="text" name="nm_obat"
                                                        value="<?php echo $pro['nm_obat']?>" maxlength="30"
                                            ...
                                            <div class="form-inline row justify-content-center
                                                ...
                                                <div class="col-sm-7 col-md-7">
                                                    <input type="text" name="jenis_obat"
                                                        value="<?php echo $pro['jenis_obat']?>" maxlength="25"
                                            ...
                                            <div class="form-inline row justify-content-center
                                                ...
                                                <div class="col-sm-7 col-md-7">
                                                    <input type="text" name="stok" value="<?php echo $pro['stok']?>"
                                            ...
                                            <div class="form-inline row justify-content-center
                                                ...
                                                <div class="col-sm-7 col-md-7">
                                                    <input type="text" name="harga_obat"
                                                        value="<?php echo $pro['harga_obat']?>" maxlength="11"
