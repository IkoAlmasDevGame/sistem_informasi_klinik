    ...
    <body>
            ...
            <div class="panel-body">
                <div class="panel-heading">
                    ...
                    <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                            <a href="?aksi=ubah-poli&id_poli=<?php echo $_GET['id_poli']?>" aria-current="page"
        ...
        <div class="card container-fluid mb-4">
            ...
            <div class="card-body mt-1">
                <?php if(isset($_GET['id_poli'])): ?>
                <?php 
                    $id = htmlspecialchars($_GET['id_poli']);
                    $sql = "SELECT * FROM tb_poli WHERE id_poli = '$id'";
                    $data = $konfigs->query($sql);
                while($isi = $data->fetch_assoc()){
                ?>
                <form action="?aksi=poli-ubah" method="post">
                    <input type="hidden" name="id_poli" value="<?php echo $id;?>">
                                ...
                                <div class="form-group mt-1 mb-1">
                                    <div class="form-inline row justify-content-center align-items-center flex-wrap">
                                        ...
                                        <div class="col-sm-7 col-md-7">
                                            <input type="text" name="kd_poli" value="<?php echo $isi['kd_poli']?>"
                                                class="form-control" maxlength="10" required aria-required="TRUE"
                                                placeholder="masukkan kode poli ..." id="">
                                        </div>
                                    </div>
                                    <div class="my-1"></div>
                                    <div class="form-inline row justify-content-center align-items-center flex-wrap">
                                        ...
                                        <div class="col-sm-7 col-md-7">
                                            <input type="text" name="nm_poli" value="<?php echo $isi['nm_poli']?>"
                                                class="form-control" maxlength="30" required aria-required="TRUE"
                                                placeholder="masukkan nama poli ..." id="">
                                        </div>
                                    </div>
                                </div>
