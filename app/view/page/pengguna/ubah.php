            ...
            <div class="panel-body">
                <div class="panel-heading">
                    ...
                    <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                            <a href="?aksi=ubah-karyawan&id_user=<?=$_GET['id_user']?>" aria-current="page"
                ...
                <div class="container-fluid">
                    <div class="table-responsive">
                        ...
                        <?php 
                            ...
                            $data = $config->prepare("SELECT * FROM tb_user WHERE id_user = ?");
                            $data->execute(array($id));
                        foreach($data as $isi){
                        ?>
                        <form action="?aksi=ubah-people" method="post">
                                             ...
                                             align-items-center flex-wrap">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <select name="jabatan" required aria-required="TRUE"
                                                        ...
                                                        <option <?php if($isi['jabatan'] == "admin"){?> selected
                                                            <?php } ?> value="admin">Admin</option>
                                                        <option <?php if($isi['jabatan'] == "pembayaran"){?> selected
                                                            <?php } ?> value="pembayaran">Pembayaran</option>
                                                        <option <?php if($isi['jabatan'] == "pendaftaran"){?> selected
                                                            <?php } ?> value="pendaftaran">Pendaftaran</option>
                                                        <option <?php if($isi['jabatan'] == "pemeriksaan"){?> selected
                                                            <?php } ?> value="pemeriksaan">Pemeriksaan</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
